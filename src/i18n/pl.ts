...
export const pl = {
  ...
  zakladki: {
    ...
    listyOpis: 'Zakupy i inne listy do odhaczania',
  ...
  daty: {
    ...
    jutro: 'jutro',
    zakres: (od: string, doDnia: string) => `${od}–${doDnia}`,
    start: (ile: string) => `start za ${ile}`,
    zostalo: (ile: string) => `zostało ${ile}`,
    ostatniDzien: 'ostatni dzień',
    poTerminieSam: (ile: string) => `${ile} po terminie`,
  ...
  zadania: {
    ...
    wazne: 'Ważne',
    termin: 'Termin',
    wielodniowe: 'Zadanie na kilka dni',
    powtarzanie: 'Powtarzanie',
    naleziDoSerii: 'To zadanie się powtarza. Zmiana dotyczy:',
    tegoZadania: 'Tego zadania',
    calejSerii: 'Całej serii',
    uwagaSeria:
      'Zapis zmieni wszystkie powtórzenia, a kosz skasuje je wszystkie. Same terminy zostają bez zmian.',
    pytanieSeria: (tytul: string) => `Usunąć wszystkie powtórzenia „${tytul}”?`,
    opisSeria: 'Znikną wszystkie powtórzenia tego zadania, także te już minione.',
    poczatek: 'Od dnia',
    koniec: 'Do dnia',
    zlyZakres: 'Początek jest późniejszy niż termin.',
  ...
  listy: {
    nowaLista: 'Nowa lista',
    edytujListe: 'Edytuj listę',
    nazwaPrzyklad: 'np. Zakupy',
    notatka: 'Notatka',
    notatkaPrzyklad: 'nieobowiązkowa — na to, czego nie da się odhaczyć',
    brakList: 'Brak list. Dodaj pierwszą plusem u góry.',
    pustaLista: 'Lista jest pusta. Dopisz pierwszą pozycję.',
    dopisz: 'Dopisz pozycję',
    zrobione: (ile: number) => `Zrobione (${ile})`,
    odznaczWszystko: 'Odznacz wszystko',
    usunZrobione: 'Usuń odhaczone',
    usunListe: 'Usuń listę',
    pytanieLista: (nazwa: string) => `Usunąć listę „${nazwa}”?`,
    opisLista: 'Zniknie razem ze wszystkimi pozycjami. Tego nie da się cofnąć.',
    pytanieZrobione: 'Usunąć odhaczone pozycje?',
    opisZrobione: 'Zostaną tylko pozycje jeszcze nieodhaczone.',
    usunPozycje: (tekst: string) => `Usuń ${tekst}`,
    postep: (zrobione: number, wszystkie: number) => `${zrobione}/${wszystkie}`,
  },
